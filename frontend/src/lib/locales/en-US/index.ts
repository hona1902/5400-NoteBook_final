export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The API server could not be reached",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow ChatBot to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of ChatBot 5400 is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across ChatBot",
    missingRequiredModels: "Missing required models: {models}. ChatBot may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in ChatBot.",
  ...
  aiProvidersDoc: {
    ...
    subtitle: "Complete setup instructions for each AI provider via the Settings UI.",
    newInV12: "New in v1.2",
    newInV12Desc: "All AI provider credentials are now managed through the Settings UI. Environment variables for API keys are deprecated.",
    backToApiKeys: "Back to API Keys",
    goToApiKeys: "Go to API Keys Settings",
    howItWorks: "How Provider Setup Works",
    howItWorksDesc: "ChatBot uses a credential-based system for managing AI providers:",
    step1: "Get your API key from the provider's website",
    step2: "Open Settings → API Keys → Add Credential",
    step3: "Test the connection to verify it works",
    step4: "Discover & Register Models to make them available",
    step5: "Start using the provider in your notebooks",
    prerequisite: "Prerequisite",
    prerequisiteDesc: "You must set OPEN_NOTEBOOK_ENCRYPTION_KEY in your docker-compose.yml before storing credentials.",
    cloudProviders: "☁️ Cloud Providers (Recommended for Most)",
    selfHosted: "🏠 Self-Hosted / Local",
    enterprise: "🏢 Enterprise",
    cost: "Cost",
    getApiKey: "Get Your API Key",
    configureInApp: "Configure in ChatBot:",
    ...
    provider_ollama_label: "Recommended for Local",
    provider_lmstudio_title: "LM Studio",
    provider_lmstudio_label: "Local Alternative",
    provider_custom: "Custom OpenAI-Compatible",
    provider_azure: "Azure OpenAI",
    openai_cost: "~$0.03–0.15 per 1K tokens (varies by model)",
    openai_adv: "Simplest setup, supports all modes (text, embedding, TTS, STT). Good quality, reasonable cost.",
    anthropic_cost: "~$0.80–3.00 per 1M tokens",
    anthropic_adv: "Great long-context support (200K tokens), excellent reasoning, fast processing.",
    gemini_cost: "~$0.075–0.30 per 1K tokens",
    gemini_adv: "Very long context (1M tokens), multimodal (images, audio, video), great for podcasts.",
    groq_cost: "~$0.05 per 1M tokens (cheapest cloud option)",
    groq_adv: "Ultra-fast inference, very cheap, great for transformations/batch work.",
    openrouter_cost: "Varies by model ($0.05–15 per 1M tokens)",
    openrouter_adv: "One API key for 100+ models, unified billing, easy model comparison. Includes OpenAI, Anthropic, Google, Meta, Mistral, DeepSeek, and many more.",
    ollama_cost: "Free (electricity only)",
    ollama_adv: "Completely private, free, no API key needed, works offline.",
    ollama_setup: "Setup Ollama:",
    ollama_install: "Install Ollama: ollama.ai",
    ollama_serve: "Run Ollama in background: ollama serve",
    ollama_pull: "Download a model: ollama pull mistral",
    ollama_baseurl: "Base URL in ChatBot:",
    ollama_local: "Same machine (non-Docker): http://localhost:11434",
    ollama_dockerhost: "Docker with Ollama on host: http://host.docker.internal:11434",
    ollama_dockercontainer: "Docker with Ollama container: http://ollama:11434",
    lmstudio_cost: "Free",
    lmstudio_adv: "GUI interface, good model selection, privacy-focused, works offline.",
    lmstudio_setup: "Setup LM Studio:",
    lmstudio_download: "Download: lmstudio.ai",
    lmstudio_openAndModel: "Open app & download a model from library",
    lmstudio_server: "Go to \"Local Server\" tab & start server (default port: 1234)",
    lmstudio_configInApp: "Configure in ChatBot:",
    lmstudio_provider: "Provider: OpenAI-Compatible",
    lmstudio_url: "Base URL (Docker): http://host.docker.internal:1234/v1",
    lmstudio_key: "API Key: lm-studio (placeholder)",
    custom_desc: "For Text Generation UI, vLLM, or other OpenAI-compatible endpoints:",
    custom_step1: "Select provider: OpenAI-Compatible",
    custom_step2: "Enter the base URL for your endpoint (e.g., http://localhost:8000/v1)",
    custom_step3: "Enter API key if required",
    custom_step4: "Click Save, then Test Connection",
    azure_cost: "Same as OpenAI (usage-based)",
    azure_adv: "Enterprise support, VPC integration, compliance (HIPAA, SOC2, etc.).",
    embeddings: "🔍 Embeddings (For Search/Semantic Features)",
    embeddingsDesc: "By default, ChatBot uses the LLM provider's embeddings. Embedding models are discovered and registered through the same credential system — when you discover models from a credential, embedding models are included alongside language models.",
    whichProvider: "Which Provider Should I Choose?",
    option_simple: "☁️ Simplest Setup",
    option_simple_desc: "Use OpenAI — cloud-based, good quality, reasonable cost, supports all modes (text, embedding, TTS, STT).",
    option_budget: "💰 Budget-Conscious",
    option_budget_desc: "Groq (super cheap cloud), OpenRouter (many open-source models), or Ollama (free, local).",
    option_privacy: "🔒 Privacy-First",
    option_privacy_desc: "Ollama or LM Studio — everything stays local, works offline, no API keys sent anywhere.",
    option_enterprise: "🏢 Enterprise",
    option_enterprise_desc: "Azure OpenAI — compliance (HIPAA, SOC2), VPC integration, enterprise support.",
    nextSteps: "Next Steps",
    nextStep1: "Choose your provider from above",
    nextStep2: "Get API key (if cloud) or install locally (if Ollama)",
    nextStep3: "Set OPEN_NOTEBOOK_ENCRYPTION_KEY in your docker-compose.yml",
    nextStep4: "Open Settings → API Keys → Add Credential",
    nextStep5: "Test Connection to verify it works",
    nextStep6: "Discover & Register Models to make them available",
    nextStep7: "Verify it works with a test chat",
    nextStepsTip: "Tip: You can add credentials for as many providers as you want. Create separate credentials for different projects or team members.",
    legacyTitle: "Legacy: Environment Variables (Deprecated)",
    legacyWarning: "Deprecated: Configuring AI provider API keys via environment variables is deprecated. Use the Settings UI instead. Environment variables may still work as a fallback but are no longer the recommended approach.",
    legacyDesc: "If you are migrating from an older version, go to Settings → API Keys and click the Migrate to Database button to import your existing keys into the credential system.",
  },
}
