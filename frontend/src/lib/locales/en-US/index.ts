export const enUS = {
  common: {
    ...
    dislike: "Dislike",
    report: "Report",
    reportDesc: "Please tell us what is wrong with this answer.",
    reportPlaceholder: "e.g., Inaccurate information, inappropriate content, etc.",
    submit: "Submit",
    ...
    insightsForSources: "Insights for {count} source",
    insightsForSourcesPlural: "Insights for {count} sources",
    fullSources: "{count} full source",
    fullSourcesPlural: "{count} full sources",
    fullNote: "{count} full note",
    fullNotePlural: "{count} full notes",
  ...
  users: {
    ...
    addNewUserDesc: "Add a new user account to the system.",
    username: "Username",
    password: "Password",
    role: "Role",
    ...
    changePasswordDesc: "Set a new password for user \"{name}\".",
    newPassword: "New Password",
    enterNewPassword: "Enter new password",
    changeRole: "Change Role",
    changeRoleDesc: "Change role for user \"{name}\".",
    userCreated: "User \"{name}\" created successfully",
    userDeleted: "User \"{name}\" deleted",
    passwordChanged: "Password changed for \"{name}\"",
    roleUpdated: "Role updated for \"{name}\" → {role}",
    ...
    manageAccountsRolesPasswords: "Manage user accounts, roles, and passwords",
    addUser: "Add User",
    usersCount: "Users ({count})",
    allRegisteredAccounts: "All registered user accounts",
    noUsersFoundAddHint: "No users found. Click \"Add User\" to create one.",
    addNewUser: "Add New User",
    createNewAccount: "Create a new user account",
  ...
  aiProviders: {
    ...
    pageTitle: "AI Providers — Configuration Guide",
    pageDesc: "Complete setup instructions for each AI provider via the Settings UI.",
    newInV12: "New in v1.2: All AI provider credentials are now managed through the Settings UI. Environment variables for API keys are deprecated.",
    howItWorksTitle: "How Provider Setup Works",
    howItWorksSteps: [
      "Get your API key from the provider's website",
      "Open Settings → API Keys → Add Credential",
      "Test the connection to verify it works",
      "Discover & Register Models to make them available",
      "Start using the provider in your notebooks",
    ],
    prerequisite: "Prerequisite: You must set OPEN_NOTEBOOK_ENCRYPTION_KEY in your docker-compose.yml before storing credentials.",
    labelSetupSteps: "Setup Steps:",
    labelModels: "Models:",
    labelRecommended: "Recommended:",
    labelCostEstimate: "Cost Estimate:",
    labelHardwareReq: "Hardware Requirements:",
    labelAdvantages: "Advantages:",
    labelDisadvantages: "Disadvantages:",
    labelTroubleshooting: "Troubleshooting:",
    ...
    cloudProviders: [
      {
        ...
        steps: [
          ...
          "In Open Notebook: Settings → API Keys → Add Credential → OpenAI",
          "Paste your API key, Save, then Test Connection",
          "Click Discover Models → Register Models",
        ],
        models: ["gpt-4o", "gpt-4o-mini", "o1", "o1-mini"],
        recommended: [
          "General use: gpt-4o (best balance)",
          "Testing / cheap: gpt-4o-mini (90% cheaper)",
          "Complex reasoning: o1 (best for hard problems)",
        ],
        costEstimate: ["Light: $1–5/mo", "Medium: $10–30/mo", "Heavy: $50–100+/mo"],
        troubleshooting: [
          "\"Invalid API key\" → Check key starts with \"sk-proj-\"",
          "\"Rate limit exceeded\" → Wait or upgrade account",
          "\"Model not available\" → Try gpt-4o-mini or re-discover models",
        ],
      },
      {
        name: "Anthropic (Claude)",
        cost: "~$0.80–3.00 / 1M tokens",
        steps: [
          "Go to https://console.anthropic.com/",
          "Create account or login",
          "Go to API keys section",
          "Create new API key (starts with \"sk-ant-\")",
          "In Open Notebook: Settings → API Keys → Add Credential → Anthropic",
          "Paste your API key, Save, then Test Connection",
          "Click Discover Models → Register Models",
        ],
        models: ["claude-sonnet-4-5", "claude-3-5-sonnet", "claude-3-5-haiku", "claude-opus-4-5"],
        recommended: [
          "General use: claude-sonnet-4-5 (best overall, latest)",
          "Cheap: claude-3-5-haiku (80% cheaper)",
          "Complex: claude-opus-4-5 (most capable)",
        ],
        costEstimate: ["Sonnet: $3–20/mo", "Haiku: $0.50–3/mo", "Opus: $10–50+/mo"],
        advantages: ["Great long-context support (200K tokens)", "Excellent reasoning", "Fast processing"],
        troubleshooting: [
      ...
      {
        name: "Google Gemini",
        cost: "~$0.075–0.30 / 1K tokens",
        steps: [
          "Go to https://aistudio.google.com/app/apikey",
          "Create account or login",
          "Create new API key",
          "In Open Notebook: Settings → API Keys → Add Credential → Google Gemini",
          "Paste your API key, Save, then Test Connection",
          "Click Discover Models → Register Models",
        ],
        models: ["gemini-2.0-flash-exp", "gemini-2.0-flash", "gemini-1.5-pro-latest"],
        recommended: [
          "General use: gemini-2.0-flash-exp (best value, latest)",
          "Cheap: gemini-1.5-flash (very cheap)",
          "Complex / long context: gemini-1.5-pro-latest (2M token context)",
        ],
        advantages: ["Very long context (1M tokens)", "Multimodal (images, audio, video)", "Good for podcasts"],
        troubleshooting: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Create account or login",
          "Create new API key",
          "In Open Notebook: Settings → API Keys → Add Credential → Groq",
          "Paste your API key, Save, then Test Connection",
          "Click Discover Models → Register Models",
        ],
        models: ["llama-3.3-70b-versatile", "llama-3.1-70b-versatile", "mixtral-8x7b-32768", "gemma2-9b-it"],
        recommended: [
          "Quality: llama-3.3-70b-versatile (best overall)",
          "Speed: gemma2-9b-it (ultra-fast)",
          "Balance: llama-3.1-70b-versatile",
        ],
        advantages: ["Ultra-fast inference", "Very cheap", "Great for transformations / batch work"],
        disadvantages: ["Limited model selection", "Smaller models than OpenAI/Anthropic"],
        troubleshooting: [
      ...
      {
        name: "OpenRouter",
        cost: "$0.05–15 / 1M tokens",
        steps: [
          "Go to https://openrouter.ai/keys",
          "Create account or login",
          "Add credits to your account",
          "Create new API key",
          "In Open Notebook: Settings → API Keys → Add Credential → OpenRouter",
          "Paste your API key, Save, then Test Connection",
          "Click Discover Models → Register Models",
        ],
        ...
        recommended: [
          "Quality: anthropic/claude-sonnet-4.5 (best overall)",
          "Speed / cost: google/gemini-2.0-flash-exp",
          "Open-source: meta-llama/llama-3.3-70b-instruct",
          "Reasoning: openai/o1",
        ],
        costEstimate: ["Light: $1–5/mo", "Medium: $10–30/mo", "Heavy: Depends on models chosen"],
        advantages: ["One API key for 100+ models", "Unified billing", "Easy model comparison", "Access to models with waitlists elsewhere"],
        troubleshooting: [
    ...
    selfHostedTitle: "Self-Hosted / Local",
    selfHostedProviders: [
      {
        name: "Ollama (Recommended for Local)",
        cost: "Free (electricity only)",
        steps: [
          "Install Ollama: https://ollama.ai",
          "Run Ollama in background: ollama serve",
          "Download a model: ollama pull mistral",
          "In Open Notebook: Settings → API Keys → Add Credential → Ollama",
          "Enter base URL: http://localhost:11434 (local) or http://host.docker.internal:11434 (Docker)",
          "Save, then Test Connection",
          "Click Discover Models → Register Models",
        ],
        models: ["llama3.3:70b", "llama3.1:8b", "qwen2.5:7b", "mistral:7b", "phi3:3.8b", "gemma2:9b"],
        recommended: [
          "Quality (with GPU): llama3.3:70b (best)",
          "General use: llama3.1:8b (best balance)",
          "Speed / low memory: phi3:3.8b (very fast)",
          "Coding: qwen2.5:7b (excellent at code)",
        ],
        hardwareRequirements: [
          "GPU 8GB VRAM: Runs most models fine",
          "GPU 6GB VRAM: Works, slower",
          "GPU 4GB VRAM: Small models only",
          "CPU 16GB+ RAM: Slow but works",
          "CPU 8GB RAM: Very slow",
        ],
        advantages: ["Completely private (runs locally)", "Free (electricity only)", "No API key needed", "Works offline"],
        disadvantages: ["Slower than cloud (unless on GPU)", "Smaller models than cloud", "Requires local hardware"],
        troubleshooting: [
      ...
      {
        name: "LM Studio (Local Alternative)",
        cost: "Free",
        steps: [
          "Download LM Studio: https://lmstudio.ai",
          "Open app, download a model from library",
          "Go to \"Local Server\" tab, start server (default port: 1234)",
          "In Open Notebook: Settings → API Keys → Add Credential → OpenAI-Compatible",
          "Enter base URL: http://localhost:1234/v1 (local) or http://host.docker.internal:1234/v1 (Docker)",
          "API key: lm-studio (placeholder)",
          "Save, then Test Connection",
        ],
        advantages: ["GUI interface (easier than Ollama)", "Good model selection", "Privacy-focused", "Works offline"],
        disadvantages: ["Desktop only (Mac/Windows/Linux)", "Slower than cloud", "Requires local GPU"],
      },
      {
        ...
        steps: [
          "In Open Notebook: Settings → API Keys → Add Credential → OpenAI-Compatible",
          "Enter your endpoint base URL (e.g., http://localhost:8000/v1)",
          "Enter API key if required",
          "Optionally configure per-service URLs (LLM, Embedding, TTS, STT)",
          "Save, then Test Connection",
        ],
      },
    ],
    ...
    enterpriseProviders: [
      {
        ...
        steps: [
          ...
          "Deploy GPT-4 / 3.5-turbo model",
          "Get your endpoint and key",
          "In Open Notebook: Settings → API Keys → Add Credential → Azure OpenAI",
          "Fill in: API Key, Endpoint, API Version",
          "Optionally configure service-specific endpoints",
          "Save, then Test Connection",
        ],
        advantages: ["Enterprise support", "VPC integration", "Compliance (HIPAA, SOC2, etc.)"],
        disadvantages: ["More complex setup", "Higher overhead", "Requires Azure account"],
      },
    ],
    embeddingsTitle: "Embeddings (Search / Semantic Features)",
    embeddingsDesc: "By default, Open Notebook uses the LLM provider's embeddings. Embedding models are discovered and registered through the same credential system — when you discover models from a credential, embedding models are included alongside language models.",
    choosingTitle: "Choosing Your Provider",
    choosingOptions: [
      {
        label: "Don't want to run locally, simple setup:",
        providers: "OpenAI",
        desc: "Cloud-based, good quality, reasonable cost, supports all modes (text, embedding, TTS, STT).",
      },
      {
        label: "Budget-conscious:",
        providers: "Groq, OpenRouter, or Ollama",
        desc: "Groq: super cheap cloud. Ollama: free, local. OpenRouter: many open-source models accessible.",
      },
      {
        label: "Privacy-first:",
        providers: "Ollama or LM Studio",
        desc: "Everything stays local. Works offline. No API keys sent anywhere.",
      },
      {
        label: "Enterprise:",
        providers: "Azure OpenAI",
        desc: "Compliance, VPC integration, support.",
      },
    ],
    ...
    nextSteps: [
      ...
      "Set OPEN_NOTEBOOK_ENCRYPTION_KEY in your docker-compose.yml",
      "Open Settings → API Keys → Add Credential",
      "Test Connection to verify it works",
      "Discover & Register Models to make them available",
      "Verify it works with a test chat",
    ],
    multipleProvidersNote: "Multiple providers: You can add credentials for as many providers as you want. Create separate credentials for different projects or team members.",
    legacyTitle: "Legacy: Environment Variables (Deprecated)",
    legacyDeprecated: "Deprecated",
    legacyDesc: "Configuring AI provider API keys via environment variables is deprecated. Use the Settings UI instead. Environment variables may still work as a fallback but are no longer the recommended approach.",
    legacyMigration: "If you are migrating from an older version that used environment variables, go to Settings → API Keys and click the Migrate to Database button to import your existing keys into the credential system.",
    relatedTitle: "Related Documentation",
    relatedLinks: [
      { label: "API Configuration", desc: "Detailed credential management guide" },
      { label: "Environment Reference", desc: "Complete list of all environment variables" },
      { label: "Advanced Configuration", desc: "Timeouts, SSL, performance tuning" },
      { label: "Ollama Setup", desc: "Detailed Ollama configuration guide" },
      { label: "OpenAI-Compatible", desc: "LM Studio and other compatible providers" },
      { label: "Local TTS Setup", desc: "Text-to-speech with Speaches" },
      { label: "Local STT Setup", desc: "Speech-to-text with Speaches" },
